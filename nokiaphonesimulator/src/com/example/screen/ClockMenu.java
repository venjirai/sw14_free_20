...
public class ClockMenu extends Screen
{
    ...
    public ClockMenu(NokiaPhoneActivity nokia_phone)
    {
        super(nokia_phone);

        this.menu_titles_line1 = new ArrayList<String>();
        this.menu_titles_line1.add("Stopwatch");
    ...
    public void show()
    {
        ...
        nokia_phone.setScreenId(ScreenId.CLOCK_MENU);
    }
