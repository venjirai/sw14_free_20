...
public class NokiaPhoneActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		sound_player = new SoundPlayer(context);
